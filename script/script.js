...
var chat = {
    ...
    init : function(){
        ...
        $('#submitForm').submit(function(){
            ...
            $.tzPOST('chat',$(this).serialize(),function(r){
                working = false;
...
$.tzPOST = function(action,data,callback){
    $.post('api/'+ action,data,callback,'json');
}

$.tzGET = function(action,data,callback){
    $.get('api/'+ action,data,callback,'json');
}
